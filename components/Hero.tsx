  ...
  return (
    <div className='pb-20 pt-36'>
        ...
        <div className='flex justify-center relative my-20 z-10'>
            ...
            justify-center">
                <h2 className='uppercase tracking-widest text-xs text-corner text-center text-blue-100 max-w-80'>
                Dynamic Web Dev with Next.js
                </h2>
                <TextGenerateEffect 
                 className="tracking-wider text-center text-[40px] md: text-5xl lg:text-6xl"
                 words="Hi, I am Ujjwal Dhakal, exploring web development using Next.js."
                />
